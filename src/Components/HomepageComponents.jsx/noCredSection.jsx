...
export default function NoCredSection(){
    ...
    return <>
        <div style={mainDiv}>
                ...
                <Button borderRadius={"12px"} h={"50px"} fontWeight={"500"} fontSize={"24px"} _hover={{bg:"#2750ae"}} variant={"solid"} color={"white"} backgroundColor={"#2750fd"}>Sign up for free</Button>
